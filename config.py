...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://tera:<maheshwar>@cluster0.jier5bt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "lust")
