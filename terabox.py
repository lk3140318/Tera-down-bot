...
api_id = os.environ.get('TELEGRAM_API', 23142306)
if len(api_id) == 0:
    logging.error("TELEGRAM_API variable is missing! Exiting now")
    exit(1)

api_hash = os.environ.get('TELEGRAM_HASH', 'a5743330c99fe35b67c19f02a3cdc0fd')
if len(api_hash) == 0:
    logging.error("TELEGRAM_HASH variable is missing! Exiting now")
    exit(1)
    
bot_token = os.environ.get('BOT_TOKEN', '7099498951:AAFdsFeBWgpOkYBiW_ALqxQZ3yz6vNevm98')
if len(bot_token) == 0:
    logging.error("BOT_TOKEN variable is missing! Exiting now")
    exit(1)
dump_id = os.environ.get('DUMP_CHAT_ID', '-1001923289050')
if len(dump_id) == 0:
...
fsub_id = os.environ.get('FSUB_ID', '-1001907166812')
if len(fsub_id) == 0:
...
@app.on_message(filters.command("broadcast") & filters.user1720819569())  # Replace <your_user_id> with your actual user ID to restrict this command
